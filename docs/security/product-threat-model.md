...
| Supply-chain artifact tampering | Clean source, exact OCI revision, rebuilt skills, scans, SBOM, immutable version-and-digest references, signed provenance | Local wheel/skills/SBOM/scan artifacts exist. The 14 reviewed no-vendor-fix exceptions expired on 2026-08-18 and do not authorize a release without a new bounded owner review; source vulnerability/secret/misconfiguration gating excludes operator-owned directories from distributable output. No final exact-commit checksum manifest, registry digest, tag, signature/provenance, or publication is claimed. |
