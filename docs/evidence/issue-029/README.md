...
| Focused upload suites | 71 unit/contract/security/PostgreSQL cases passed, including real-current-PR issuance, head-update races, strict archive EOF, direct-INSERT lifecycle rejection, recovery/finalizer and decommission/finalizer races, exact repository/scope recovery, retention-renewal serialization, cleanup retry, live storage, and immutable blob linking. |
