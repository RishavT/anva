...
| V3 24.6–24.8 | Tracing, alerts and runbooks | candidate/deferred | Correlation/W3C trace IDs, process metrics and triage instructions are implemented | MVP: authenticated deployed scrape/proxy and triage exercise ([#43](https://github.com/RishavT/anva/issues/43), [#44](https://github.com/RishavT/anva/issues/44)); post-MVP: persistent aggregation, dashboards, managed alerts, and distributed trace export ([#39](https://github.com/RishavT/anva/issues/39)) |
| V3 M6 | Rate limits, retention, operations, security review | candidate/missing | Limits and retention have historical exact-source test evidence; the current scrape/proxy triage exercise and completion security audit are absent; managed alerts are deferred | Exact-candidate operational/security review under [#43](https://github.com/RishavT/anva/issues/43) and [#44](https://github.com/RishavT/anva/issues/44); pilot-usage and managed-alert targets remain post-MVP outcomes |
...
| V3 28.17; OPS-003/004 | Dashboards and alerting | deferred | Process-local metrics and MVP triage instructions only | Persistent dashboards and managed alert delivery are post-MVP under [#39](https://github.com/RishavT/anva/issues/39); the implemented scrape/proxy and triage exercise remains an MVP gate |
...
| V3 28.17; OPS-012 | Status/incident communication | candidate/deferred | Essential self-hosted triage procedures exist, but accountable release/security/operations owners and an exercise record are absent | MVP: deployment-owned contacts and essential runbook exercise under [#44](https://github.com/RishavT/anva/issues/44); post-MVP managed status communication under [#40](https://github.com/RishavT/anva/issues/40) |
