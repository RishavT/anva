...
rejected for v0.1.3. The local gate requires an explicit external decision
...
See the [v0.1.3 release notes](docs/releases/v0.1.3.md), [compatibility
...
remains historical until the protected v0.1.3 release completes.
